...
Node {
    ...
    Texture {
        ...
        source: "maps/qtmesh_gen3d_1_1788698198143_diffuse.png"
    }
    Texture {
        ...
        generateMipmaps: true
        mipFilter: Texture.Linear
        source: "maps/qtmesh_gen3d_1_1788698198143_roughness.png"
    }
    Texture {
        ...
        generateMipmaps: true
        mipFilter: Texture.Linear
        source: "maps/qtmesh_gen3d_1_1788698198143_normal.png"
    }
    PrincipledMaterial {
