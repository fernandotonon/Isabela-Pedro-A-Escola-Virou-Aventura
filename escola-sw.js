/*! escola-sw.js - service worker for the web build of "Isabela & Pedro: A Escola Virou Aventura".
 ...
 *  74e04395b04c is replaced at deploy time; a new build means a new cache, old ones are dropped. */
const BUILD_ID = "74e04395b04c";
...
if (typeof window === "undefined") {
    ...
    const isGameFile = (url) => {
        ...
        return url.origin === self.location.origin && !p.endsWith("/") && !p.endsWith(".html") && !p.endsWith("escola-sw.js") &&
